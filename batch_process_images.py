...
def process_single_image(url: str, run_id: str, index: int, total: int) -> bool:
    ...
    # Step 1: Run analyze_drone_image_yolo.py with URL parameter  models: --model "llava:13b" or --model "qwen2.5vl:latest" llava:34b,
    print("\n[Step 1/3] Running analysis...")
    
    cmd = f'python analyze_drone_image_yolo.py --url "{url}" --model "qwen2.5vl:32b" '
